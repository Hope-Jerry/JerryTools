import{_ as l}from"../vue-img-cutter/vue-img-cutter.f6f262e7.js";import{r as a,i as p,ag as o,o as u,c as g,a as h,V as r,P as v}from"../@vue/@vue.bb851dd4.js";const _={class:"page"},s=`<h1 align="center">Markdown Editor built on Vue</h1>
...
`,k={__name:"page-markdown",setup(f){const e=a(null),n=a(400);p(()=>{n.value=i()});const i=()=>e.value.offsetHeight;return(w,t)=>{const d=o("v-md-editor"),m=o("el-card");return u(),g("div",_,[h("div",{ref_key:"velCardEleRef",ref:e},[r(m,{shadow:"never",class:"vel_card_override"},{default:v(()=>[r(d,{modelValue:s,"onUpdate:modelValue":t[0]||(t[0]=c=>s=c),height:n.value+"px"},null,8,["height"])]),_:1})],512)])}}},x=l(k,[["__scopeId","data-v-a5a96c92"]]);export{x as default};
